...
export const webProjects = [
  {
    ...
    description: [
      'European Eye Center had a clean but generic website that lacked personality, SEO, and persuasive structure. Patients couldn’t find key information, visuals were dark or outdated, and contact forms collected unnecessary, even uncomfortable data — all contributing to low conversions. ',
    ...
    result:
      'The result was a fully modernized, SEO-driven platform that felt warm, trustworthy, and medically professional — leading to a 5X increase in traffic, top 10 keyword rankings in four languages, and more doctor appointment form submissions.',
    image: EECwebProject,
  ...
  },
  {
    ...
    description: [
      'Top Vision’s original site was minimal, with just two pages and no product listings or SEO. Before I could audit it, the entire site crashed — erased without backup. As the brand’s only marketer, I led the rebuild from zero: redesigning the site, recreating the brand’s color identity, and crafting a hybrid e-commerce platform.',
...
export const hireMeContent = [
  {
    id: 4,
    h3: '👩‍💼 Hire Me as a Digital Marketer',
  ...
  {
    id: 5,
    h3: '💻  Hire Me as a Website Design & WordPress Expert',
    jobType: 'Full-time | Online, Hybrid, On-site',
    taskList: [
      ...
      'Building bilingual websites (Vietnamese–English) tailored to your audience',
  ...
  {
    id: 6,
    h3: '🎨 Hire Me as a Marketing Designer',
  ...
  {
    id: 7,
    h3: '✍️ Hire Me as a Social Media Specialist',
